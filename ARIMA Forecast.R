...
dlRO = data.xts$l_diff_RO["1973-02/2018-06"]
dlRO.ts <- ts(dlRO, frequency=12,start=c(1973, 2), end=c(2018, 6))
...
test_dh1 = subset(dlRO.ts[, "l_diff_RO"],start=365,end = 545)
test_h3 = subset(lRO.ts[, "lRO"],start=367,end = 545)
test_dh3 = subset(dlRO.ts[, "l_diff_RO"],start=367,end = 545)
test_h6 = subset(lRO.ts[, "lRO"],start=370,end = 545)
test_dh6 = subset(dlRO.ts[, "l_diff_RO"],start=370,end = 545)
test_h9 = subset(lRO.ts[, "lRO"],start=373,end = 545)
test_dh9 = subset(dlRO.ts[, "l_diff_RO"],start=373,end = 545)
test_h12 = subset(lRO.ts[, "lRO"],start=376,end = 545)
test_dh12 = subset(dlRO.ts[, "l_diff_RO"],start=376,end = 545)
