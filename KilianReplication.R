...
#Killian
{
  m_h1=matrix(nrow=214, ncol=nc)
  m_h3=matrix(nrow=214, ncol=nc)
  m_h6=matrix(nrow=214, ncol=nc)
  m_h9=matrix(nrow=214, ncol=nc)
  m_h12=matrix(nrow=214, ncol=nc)
  
  VAR.ts <- ts(data.xts[-1,c("Kilian","dOI","lRO","OP")],frequency=12,start=c(1974, 2), end=c(2009, 8))
  VAR2.ts <- ts(data.xts[-1,c("Kilian","lRO","OP")],frequency=12,start=c(1974, 2), end=c(2009, 8)) 
  VAR3.ts <- ts(data.xts[-1,c("Kilian","lRO")],frequency=12,start=c(1974, 2), end=c(2009, 8)) 
  VAR4.ts <- ts(data.xts[-1,c("dOI","lRO")],frequency=12,start=c(1974, 2), end=c(2009, 8))
  VAR5.ts <- ts(data.xts[-1,c("lRO","OP")],frequency=12,start=c(1974, 2), end=c(2009, 8))
  VAR6.ts <- ts(data.xts[-1,c("Kilian", "dOI", "lRO")],frequency=12,start=c(1974, 2), end=c(2009, 8)) 
  dVAR.ts <- ts(data.xts[-1,c("Kilian","dOI","l_diff_RO","OP")] ,frequency=12,start=c(1974, 2), end=c(2009, 8))
}
for (j in 1:nc){
  for (i in 0:213) {
    ...
    if (j==1){VARf <- VAR(train, p=1, season = 12)}
    if (j==2){VARf <- VAR(train, p=12, season = 12)}
    if (j==3){VARf <- VAR(train, p=24, season = 12)}
    
    if (j==4){VARf <- VAR(train2, p=1, season = 12)}
    if (j==5){VARf <- VAR(train2, p=12, season = 12)}
    if (j==6){VARf <- VAR(train2, p=24, season = 12)}
    
    if (j==7){VARf <- VAR(train3, p=1, season = 12)}
    if (j==8){VARf <- VAR(train3, p=12, season = 12)}
    if (j==9){VARf <- VAR(train3, p=24, season = 12)}
    
    if (j==10){VARf <- VAR(train4, p=1, season = 12)}
    if (j==11){VARf <- VAR(train4, p=12, season = 12)}
    if (j==12){VARf <- VAR(train4, p=24, season = 12)}
    
    if (j==13){VARf <- VAR(train5, p=1, season = 12)}
    if (j==14){VARf <- VAR(train5, p=12, season = 12)}
    if (j==15){VARf <- VAR(train5, p=24, season = 12)}
    
    if (j==16){VARf <- VAR(train6, p=1, season = 12)}
    if (j==17){VARf <- VAR(train6, p=12, season = 12)}
    if (j==18){VARf <- VAR(train6, p=24, season = 12)}
    
    if (j==19){VARf <- VAR(traind, p=12, season = 12)}
    if (j==20){VARf <- VAR(traind, p=24, season = 12)}
...
{
  test_h1 = subset(VAR.ts[, "lRO"],start=215,end = 427)
  test_dh1 = subset(dVAR.ts[, "l_diff_RO"],start=215,end = 427)
  test_h3 = subset(VAR.ts[, "lRO"],start=217,end = 427)
  test_dh3 = subset(dVAR.ts[, "l_diff_RO"],start=217,end = 427)
  test_h6 = subset(VAR.ts[, "lRO"],start=220,end = 427)
  test_dh6 = subset(dVAR.ts[, "l_diff_RO"],start=220,end = 427)
  test_h9 = subset(VAR.ts[, "lRO"],start=223,end = 427)
  test_dh9 = subset(dVAR.ts[, "l_diff_RO"],start=223,end = 427)
  test_h12 = subset(VAR.ts[, "lRO"],start=226,end = 427)
  test_dh12 = subset(dVAR.ts[, "l_diff_RO"],start=226,end = 427)
  ...
  RWf_h6.ts = ts(RW[1:208], frequency=12, start=c(1992, 5), end=c(2009, 8))
  RWf_h9.ts = ts(RW[1:205], frequency=12, start=c(1992, 8), end=c(2009, 8))
  RWf_h12.ts = ts(RW[1:202], frequency=12, start=c(1992, 11), end=c(2009, 8))
}
...
for (i in 1:nc) {
  VARf.ts = ts(m_h1[1:213,i], frequency=12, start=c(1991, 12), end=c(2009, 8))
  if(i<x){
...
for (i in 1:nc) {
  VARf.ts = ts(m_h3[1:211,i], frequency=12, start=c(1992, 2), end=c(2009, 8))
  if(i<x){
...
for (i in 1:nc) {
  VARf.ts = ts(m_h6[1:208,i], frequency=12, start=c(1992, 5), end=c(2009, 8))
  if(i<x){
...
for (i in 1:nc) {
  VARf.ts = ts(m_h9[1:205,i], frequency=12, start=c(1992, 8), end=c(2009, 8))
  if(i<x){
...
for (i in 1:nc) {
  VARf.ts = ts(m_h12[1:202,i], frequency=12, start=c(1992, 11), end=c(2009, 8))
  if(i<x){
