...
#HamiltonOECD
{
  ...
  VAR.ts <- ts(data.xts[-1,c("HamiltonOECD","dOI","lRO","OP")],frequency=12,start=c(1973, 2), end=c(2018, 6))
  VAR2.ts <- ts(data.xts[-1,c("HamiltonOECD","lRO","OP")],frequency=12,start=c(1973, 2), end=c(2018, 6))
  VAR3.ts <- ts(data.xts[-1,c("HamiltonOECD","lRO")],frequency=12,start=c(1973, 2), end=c(2018, 6))
  VAR4.ts <- ts(data.xts[-1,c("dOI","lRO")],frequency=12,start=c(1973, 2), end=c(2018, 6))
  VAR5.ts <- ts(data.xts[-1,c("lRO","OP")],frequency=12,start=c(1973, 2), end=c(2018, 6))
  VAR6.ts <- ts(data.xts[-1,c("HamiltonOECD","dOI","lRO")],frequency=12,start=c(1973, 2), end=c(2018, 6))
  dVAR.ts <- ts(data.xts[-1,c("HamiltonOECD","dOI","l_diff_RO","OP")] ,frequency=12,start=c(1973, 2), end=c(2018, 6))
}
for (j in 1:nc){
  for (i in 0:181) {
    train = VAR.ts[1:(364+i), ]
...
test_h6 = subset(VAR.ts[, "lRO"],start=370,end = 545)
test_dh6 = subset(dVAR.ts[, "l_diff_RO"],start=370,end = 545)
test_h9 = subset(VAR.ts[, "lRO"],start=373,end = 545)
test_dh9 = subset(dVAR.ts[, "l_diff_RO"],start=373,end = 545)
test_h12 = subset(VAR.ts[, "lRO"],start=376,end = 545)
test_dh12 = subset(dVAR.ts[, "l_diff_RO"],start=376,end = 545)
