...
data$OPy = log(data$`World oil prod`) - lag.xts(log(data$`World oil prod`),k = 12) 

#plot(data$OPy, type="l")
#lOI = log(data$OI)
#plot(lOI, type="l")
data$dOIy = diff.xts(data$OI,differences = 1)

#data$OPy = na.omit(data$)
#OPy = na.omit(data$OPy)
#summary(ur.df(OPy, type = "trend", lags=12)) #stationær

data.xts <- xts(data[-1], data[[1]])
data.xts <- data.xts["1973-12/2018-06"]
data.xts$observationer = 1:nrow(data.xts) 
View(data.xts)

# VAR modeller - Hamilton
{
  data.VAR <- data.xts[-1,c("Kilian","dOI","lRO","OPy")]
  VAR.ts <- ts(data.VAR,frequency=12,start=c(1974, 1), end=c(2018, 6))
  
  data.VAR2 <- data.xts[-1,c("HamiltonOECD","dOI","lRO","OPy")]
  VAR2.ts <- ts(data.VAR2,frequency=12,start=c(1974, 1), end=c(2018, 6))
  
  data.VAR3 <- data.xts[-1,c("Hamilton","lRO","OPy")]
  VAR3.ts <- ts(data.VAR3,frequency=12,start=c(1974, 1), end=c(2018, 6))
  
  data.VAR4 <- data.xts[-1,c("Hamilton","lRO")]
  VAR4.ts <- ts(data.VAR4,frequency=12,start=c(1974, 1), end=c(2018, 6))
  
  data.VAR5 <- data.xts[-1,c("dOI","lRO")]
  VAR5.ts <- ts(data.VAR5,frequency=12,start=c(1974, 1), end=c(2018, 6))
  
  data.VAR6 <- data.xts[-1,c("lRO","OPy")]
  VAR6.ts <- ts(data.VAR6,frequency=12,start=c(1974, 1), end=c(2018, 6))
  
  data.VAR7 <- data.xts[-1,c("Hamilton","dOI","lRO")]
  VAR7.ts <- ts(data.VAR7,frequency=12,start=c(1974, 1), end=c(2018, 6))
  
  data.dVAR <- data.xts[-1,c("Hamilton","dOI","l_diff_RO","OPy")] 
  dVAR.ts <- ts(data.dVAR,frequency=12,start=c(1974, 1), end=c(2018, 6))
}


nc=23
x=22
m_h1=matrix(nrow=318, ncol=nc)
m_h3=matrix(nrow=318, ncol=nc)
m_h6=matrix(nrow=318, ncol=nc)
m_h9=matrix(nrow=318, ncol=nc)
m_h12=matrix(nrow=318, ncol=nc)

for (j in 1:nc){
  for (i in 0:317) {
    train = VAR.ts[1:(217+i), ]
    train2 = VAR2.ts[1:(217+i), ]
    train3 = VAR3.ts[1:(217+i), ]
    train4 = VAR4.ts[1:(217+i), ]
    train5 = VAR5.ts[1:(217+i), ]
    train6 = VAR6.ts[1:(217+i), ]
    train7 = VAR7.ts[1:(217+i), ]
    traind = dVAR.ts[1:(217+i), ]
...
# Forecast Evaluation -----------------------------------------------------------------------
{
  test_h1 = subset(VAR.ts[, "lRO"],start=319,end = 534)
  test_dh1 = subset(dVAR.ts[, "l_diff_RO"],start=319,end = 534)
  test_h3 = subset(VAR.ts[, "lRO"],start=317,end = 534)
  test_dh3 = subset(dVAR.ts[, "l_diff_RO"],start=317,end = 534)
  test_h6 = subset(VAR.ts[, "lRO"],start=314,end = 534)
  test_dh6 = subset(dVAR.ts[, "l_diff_RO"],start=314,end = 534)
  test_h9 = subset(VAR.ts[, "lRO"],start=311,end = 534)
  test_dh9 = subset(dVAR.ts[, "l_diff_RO"],start=311,end = 534)
  test_h12 = subset(VAR.ts[, "lRO"],start=308,end = 534)
  test_dh12 = subset(dVAR.ts[, "l_diff_RO"],start=308,end = 534)
  
  RW = VAR.ts[-c(1:352), "lRO"]
...
for (i in 1:nc) {
  VARf.ts = ts(m_h1[1:319,i], frequency=12, start=c(2003, 6), end=c(2018, 6))
  if(i<x){
...
for (i in 1:nc) {
  VARf.ts = ts(m_h3[1:317,i], frequency=12, start=c(2003, 8), end=c(2018, 6))
  if(i<x){
...
for (i in 1:nc) {
  VARf.ts = ts(m_h6[1:314,i], frequency=12, start=c(2003, 10), end=c(2018, 6))
  if(i<x){
...
for (i in 1:nc) {
  VARf.ts = ts(m_h9[1:311,i], frequency=12, start=c(2003, 12), end=c(2018, 6))
  if(i<x){
...
for (i in 1:nc) {
  VARf.ts = ts(m_h12[1:308,i], frequency=12, start=c(2004, 2), end=c(2018, 6))
  if(i<x){
...
m.df = as.data.frame(m, row.names = c("Killian1","Killian2","Killian3",
                                      "HamiltonOECD1","HamiltonOECD2","HamiltonOECD3",
                                      "÷ Inv1", "÷ Inv2", "÷ Inv3",
...
forecast = ts(m_h1[1:319,2], frequency=12, start=c(2003, 6), end=c(2018, 6))
forecast = ts(m_h1[1:319,1], frequency=12, start=c(2003, 6), end=c(2018, 6))
actual = subset(VAR.ts[, "lRO"],start=354,end = 534)
...
dm.test(PE.VAR, PE.RW, alternative = "less", h=1, power=2)
...
# VAR modeller - Kilian
{
  ...
  data.VAR2 <- data.xts[-1,c("Hamilton","dOI","lRO","OPy")]
  VAR2.ts <- ts(data.VAR2,frequency=12,start=c(1974, 1), end=c(2018, 6))
  
  data.VAR3 <- data.xts[-1,c("Kilian","lRO","OPy")]
  VAR3.ts <- ts(data.VAR3,frequency=12,start=c(1974, 1), end=c(2018, 6))
  
  data.VAR4 <- data.xts[-1,c("Kilian","lRO")]
  VAR4.ts <- ts(data.VAR4,frequency=12,start=c(1974, 1), end=c(2018, 6))
  ...
  data.VAR7 <- data.xts[-1,c("Kilian","dOI","lRO")]
  VAR7.ts <- ts(data.VAR7,frequency=12,start=c(1974, 1), end=c(2018, 6))
  
  data.dVAR <- data.xts[-1,c("Kilian","dOI","l_diff_RO","OPy")] 
  dVAR.ts <- ts(data.dVAR,frequency=12,start=c(1974, 1), end=c(2018, 6))
}
...
# Forecast Evaluation -----------------------------------------------------------------------
{
  test_h1 = subset(VAR.ts[, "lRO"],start=354,end = 534)
  test_dh1 = subset(dVAR.ts[, "l_diff_RO"],start=354,end = 534)
  test_h3 = subset(VAR.ts[, "lRO"],start=356,end = 534)
  test_dh3 = subset(dVAR.ts[, "l_diff_RO"],start=356,end = 534)
  test_h6 = subset(VAR.ts[, "lRO"],start=358,end = 534)
  test_dh6 = subset(dVAR.ts[, "l_diff_RO"],start=358,end = 534)
  test_h9 = subset(VAR.ts[, "lRO"],start=360,end = 534)
  test_dh9 = subset(dVAR.ts[, "l_diff_RO"],start=360,end = 534)
  test_h12 = subset(VAR.ts[, "lRO"],start=362,end = 534)
  test_dh12 = subset(dVAR.ts[, "l_diff_RO"],start=362,end = 534)
  
  RW = VAR.ts[-c(1:352), "lRO"]
  
  RWf_h1.ts = ts(RW[1:317], frequency=12, start=c(2003, 6), end=c(2018, 6))
...
for (i in 1:nc) {
  VARf.ts = ts(m_h1[1:317,i], frequency=12, start=c(2003, 6), end=c(2018, 6))
  if(i<x){
    PE.VAR=VARf.ts-test_h1
    PE.RW=RWf_h1.ts-test_h1
    m[i,1]=mean((PE.VAR)^2)/mean((PE.RW)^2)
...
forecast = ts(m_h1[1:317,2], frequency=12, start=c(2003, 6), end=c(2018, 6))
forecast = ts(m_h1[1:317,1], frequency=12, start=c(2003, 6), end=c(2018, 6))
actual = subset(VAR.ts[, "lRO"],start=354,end = 534)
...
# VAR modeller - HamiltonOECD
{
  ...
  data.VAR3 <- data.xts[-1,c("HamiltonOECD","lRO","OPy")]
  VAR3.ts <- ts(data.VAR3,frequency=12,start=c(1974, 1), end=c(2018, 6))
  
  data.VAR4 <- data.xts[-1,c("HamiltonOECD","lRO")]
  VAR4.ts <- ts(data.VAR4,frequency=12,start=c(1974, 1), end=c(2018, 6))
  ...
  data.VAR7 <- data.xts[-1,c("HamiltonOECD","dOI","lRO")]
  VAR7.ts <- ts(data.VAR7,frequency=12,start=c(1974, 1), end=c(2018, 6))
  
  data.dVAR <- data.xts[-1,c("HamiltonOECD","dOI","l_diff_RO","OPy")] 
  dVAR.ts <- ts(data.dVAR,frequency=12,start=c(1974, 1), end=c(2018, 6))
}
