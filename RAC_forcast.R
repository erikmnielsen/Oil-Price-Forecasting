...
library(readxl)
RAC <- read_excel("RAC.xlsx", col_names = FALSE)
...
data$RAC <- RAC[,2]/(data$`CPI US`/100) 
...
autoplot(VAR.ts)
subset(VAR.ts[, "RAC"],start=1,end = 364)
...
#Killian
{
  ...
  VAR.ts <- ts(data.xts[-1,c("Kilian","dOI","RAC","OP")],frequency=12,start=c(1974, 2), end=c(2018, 6))
  VAR2.ts <- ts(data.xts[-1,c("Kilian","RAC","OP")],frequency=12,start=c(1974, 2), end=c(2018, 6)) 
  VAR3.ts <- ts(data.xts[-1,c("Kilian","RAC")],frequency=12,start=c(1974, 2), end=c(2018, 6)) 
  VAR4.ts <- ts(data.xts[-1,c("dOI","RAC")],frequency=12,start=c(1974, 2), end=c(2018, 6))
  VAR5.ts <- ts(data.xts[-1,c("RAC","OP")],frequency=12,start=c(1974, 2), end=c(2018, 6))
  VAR6.ts <- ts(data.xts[-1,c("Kilian", "dOI", "RAC")],frequency=12,start=c(1974, 2), end=c(2018, 6)) 
...
for (j in 1:nc){
  for (i in 0:181) {
    ...
    if (j<x){m_h1[i+1,j]=predict(VARf, n.ahead=1)$fcst$RAC[,"fcst"]}
    if (j<x){m_h3[i+1,j]=predict(VARf, n.ahead=3)$fcst$RAC[3,"fcst"]}
    if (j<x){m_h6[i+1,j]=predict(VARf, n.ahead=6)$fcst$RAC[6,"fcst"]}
    if (j<x){m_h9[i+1,j]=predict(VARf, n.ahead=9)$fcst$RAC[9,"fcst"]}
    if (j<x){m_h12[i+1,j]=predict(VARf, n.ahead=12)$fcst$RAC[12,"fcst"]}
...
#Hamilton
{
  ...
  VAR.ts <- ts(data.xts[-1,c("Hamilton","dOI","RAC","OP")],frequency=12,start=c(1974, 2), end=c(2018, 6))
  VAR2.ts <- ts(data.xts[-1,c("Hamilton","RAC","OP")],frequency=12,start=c(1974, 2), end=c(2018, 6)) 
  VAR3.ts <- ts(data.xts[-1,c("Hamilton","RAC")],frequency=12,start=c(1974, 2), end=c(2018, 6)) 
  VAR4.ts <- ts(data.xts[-1,c("dOI","RAC")],frequency=12,start=c(1974, 2), end=c(2018, 6))
  VAR5.ts <- ts(data.xts[-1,c("RAC","OP")],frequency=12,start=c(1974, 2), end=c(2018, 6))
  VAR6.ts <- ts(data.xts[-1,c("Hamilton", "dOI", "RAC")],frequency=12,start=c(1974, 2), end=c(2018, 6)) 
...
for (j in 1:nc){
  for (i in 0:181) {
    ...
    if (j<x){mH_h1[i+1,j]=predict(VARf, n.ahead=1)$fcst$RAC[,"fcst"]}
    if (j<x){mH_h3[i+1,j]=predict(VARf, n.ahead=3)$fcst$RAC[3,"fcst"]}
    if (j<x){mH_h6[i+1,j]=predict(VARf, n.ahead=6)$fcst$RAC[6,"fcst"]}
    if (j<x){mH_h9[i+1,j]=predict(VARf, n.ahead=9)$fcst$RAC[9,"fcst"]}
    if (j<x){mH_h12[i+1,j]=predict(VARf, n.ahead=12)$fcst$RAC[12,"fcst"]}
...
#Hamilton OECD
{
  ...
  VAR.ts <- ts(data.xts[-1,c("HamiltonOECD","dOI","RAC","OP")],frequency=12,start=c(1974, 2), end=c(2018, 6))
  VAR2.ts <- ts(data.xts[-1,c("HamiltonOECD","RAC","OP")],frequency=12,start=c(1974, 2), end=c(2018, 6)) 
  VAR3.ts <- ts(data.xts[-1,c("HamiltonOECD","RAC")],frequency=12,start=c(1974, 2), end=c(2018, 6)) 
  VAR4.ts <- ts(data.xts[-1,c("dOI","RAC")],frequency=12,start=c(1974, 2), end=c(2018, 6))
  VAR5.ts <- ts(data.xts[-1,c("RAC","OP")],frequency=12,start=c(1974, 2), end=c(2018, 6))
  VAR6.ts <- ts(data.xts[-1,c("HamiltonOECD", "dOI", "RAC")],frequency=12,start=c(1974, 2), end=c(2018, 6)) 
...
for (j in 1:nc){
  for (i in 0:181) {
    ...
    if (j<x){mO_h1[i+1,j]=predict(VARf, n.ahead=1)$fcst$RAC[,"fcst"]}
    if (j<x){mO_h3[i+1,j]=predict(VARf, n.ahead=3)$fcst$RAC[3,"fcst"]}
    if (j<x){mO_h6[i+1,j]=predict(VARf, n.ahead=6)$fcst$RAC[6,"fcst"]}
    if (j<x){mO_h9[i+1,j]=predict(VARf, n.ahead=9)$fcst$RAC[9,"fcst"]}
    if (j<x){mO_h12[i+1,j]=predict(VARf, n.ahead=12)$fcst$RAC[12,"fcst"]}
